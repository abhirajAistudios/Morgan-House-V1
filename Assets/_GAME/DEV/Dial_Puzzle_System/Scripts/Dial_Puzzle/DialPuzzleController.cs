...
public class DialPuzzleController : MonoBehaviour, ISaveable
{
    ...
    [Header("Sounds")] 
    [SerializeField] private Sounds dialObjInserted;
    ...
    {
        currentPlacements++;
        SoundService.Instance.Play(dialObjInserted);
    ...
    void PuzzleSolved()
    {
        ...
        EventService.Instance.OnPuzzleSolved.InvokeEvent(dialPuzzleName);                       // Notify the game service and event service that the puzzle is solved
