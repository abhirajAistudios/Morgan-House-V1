...
public class ObjectiveEditor : EditorWindow
{
    ...
    private void CreateObjective()
    {
        ...
        {
            case Objective.COLLECT:
                var collectSO = CreateInstance<CollectibleObjectiveSO>();
            ...
            case Objective.REACH:
                var reachSO = CreateInstance<ReachObjectiveSO>();
            ...
            case Objective.SOLVEPUZZLE:
                var puzzleSO = CreateInstance<SolvePuzzleObjectiveSO>();
                puzzleSO.ItemId = ItemId;
                objectiveSO = puzzleSO;
                break;

            case Objective.USE:
                var useSO = CreateInstance<UseObjectiveSO>();
                useSO.ItemId = ItemId;
                objectiveSO = useSO;
                break;
        }
